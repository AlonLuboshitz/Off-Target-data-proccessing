...
if __name__ == "__main__":
    data = pd.read_csv('/home/dsi/lubosha/Off-Target-data-proccessing/Data/Change-seq/Processed_data/NewGUIDEseq.csv')
    ...
    input_to_data_by_column(data_name='NewGUIDE-seq', guides_list=guides_1,values=active_otss,column_to_fill='vivo_otss')
    input_to_data_by_column(data_name='NewGUIDE-seq', guides_list=guides_2,values=potential_otss,column_to_fill='potential_otss')
    
    input_to_data_by_column(data_name='NewGUIDE-seq', guides_list=guides_1,values=['GUIDE-seq'] * len(guides_1),column_to_fill='vivo_method')
    input_to_data_by_column(data_name='NewGUIDE-seq', guides_list=guides_1,values=['SWOffinder']*len(guides_1),column_to_fill='potential_method')
