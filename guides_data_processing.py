...
if __name__ == "__main__":
    data = pd.read_csv('/home/dsi/lubosha/Off-Target-data-proccessing/Data/Hendel_lab/Processed_data/Hendel_RS_silico_with_epigenetics.csv')
    ...
    input_to_data_by_column(data_name='Hendel', guides_list=guides_1,values=active_otss,column_to_fill='amplified_otss')
    # input_to_data_by_column(data_name='Hendel', guides_list=guides_2,values=potential_otss,column_to_fill='potential_otss')
    
    input_to_data_by_column(data_name='Hendel', guides_list=guides_1,values=['rHamp-seq'] * len(guides_1),column_to_fill='amplified_method')
